...
public class Day02 {
    ...
    public static void main(final String[] args) {
        final List<String> input = InputUtil.lines("day02");
        final Map<Integer, Game> games = input
                .stream()
                ...
                .mapToInt(game -> {
                    ...
                    game.rounds.forEach(round ->
                            round.draws.forEach((color, qty) ->
                                    lowestBalls.compute(color, (key, oldQty) ->
                                            Math.max(oldQty, qty))));
                    return lowestBalls.values().stream().reduce(1, (a, b) -> a*b);
                })
                .sum();
